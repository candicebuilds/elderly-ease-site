      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="pt-8" style={{ borderTop: "1px solid rgba(255, 255, 255, 0.2)" }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <a href="https://facebook.com/ElderlyEase" target="_blank" rel="noopener noreferrer" className="footer-link text-sm flex items-center gap-2" style={{ color: "white" }} aria-label="Visit Elderly Ease on Facebook">

        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl mb-3" style={{ color: "#7b3f7e", fontFamily: "Poppins, sans-serif", fontSize: "24px", fontWeight: "600" }}>Dignity First</h3>
            ...
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl mb-3" style={{ color: "#7b3f7e", fontFamily: "Poppins, sans-serif", fontSize: "24px", fontWeight: "600" }}>Transparent & Reliable</h3>
              <p style={{ color: "#585858", fontFamily: "Poppins, sans-serif", fontWeight: "400", fontSize: "16px", lineHeight: "1.6" }}>
            ...
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl mb-3" style={{ color: "#7b3f7e", fontFamily: "Poppins, sans-serif", fontSize: "24px", fontWeight: "600" }}>Family‑Run with Heart</h3>
              <p style={{ color: "#585858", fontFamily: "Poppins, sans-serif", fontWeight: "400", fontSize: "16px", lineHeight: "1.6" }}>
            ...
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl mb-3" style={{ color: "#7b3f7e", fontFamily: "Poppins, sans-serif", fontSize: "24px", fontWeight: "600" }}>Holistic Support</h3>
              <p style={{ color: "#585858", fontFamily: "Poppins, sans-serif", fontWeight: "400", fontSize: "16px", lineHeight: "1.6" }}>

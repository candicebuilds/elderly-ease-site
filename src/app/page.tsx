        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition border-t-4" style={{ borderTopColor: "#6ec6ca", boxShadow: "0 4px 6px -1px rgba(110, 198, 202, 0.2)" }}>
              <div className="p-8 flex flex-col h-full">
                ...
                <p className="text-center mt-2" style={{ fontSize: "12px", color: "#585858" }}>
                  Don't have WhatsApp? <a href="mailto:hello@elderlyease.co.za?subject=Inquiry%20regarding%20the%20Essential%20Plan" className="email-alt-link">Email us here</a>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition border-t-4" style={{ borderTopColor: "#e1a5af", boxShadow: "0 10px 15px -3px rgba(225, 165, 175, 0.2)" }}>
              <div className="p-8 bg-gradient-to-br from-gray-50 to-transparent flex flex-col h-full">
                ...
                <p className="text-center mt-2" style={{ fontSize: "12px", color: "#585858" }}>
                  Don't have WhatsApp? <a href="mailto:hello@elderlyease.co.za?subject=Inquiry%20regarding%20the%20Comfort%20Plan" className="email-alt-link">Email us here</a>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition border-t-4" style={{ borderTopColor: "#7b3f7e", boxShadow: "0 4px 6px -1px rgba(123, 63, 126, 0.2)" }}>
              <div className="p-8 flex flex-col h-full">
                ...
                <p className="text-center mt-2" style={{ fontSize: "12px", color: "#585858" }}>
                  Don't have WhatsApp? <a href="mailto:hello@elderlyease.co.za?subject=Inquiry%20regarding%20the%20Complete%20Care%20Plan" className="email-alt-link">Email us here</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <a href="mailto:hello@elderlyease.co.za?subject=Request%20for%20Custom%20Ease%20Tailored%20Plan" className="font-medium hover:opacity-80 transition inline-block" style={{ color: "#7b3f7e" }}>Get Custom Quote →</a>
            </div>
